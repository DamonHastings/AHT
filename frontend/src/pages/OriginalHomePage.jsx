...
/**
 * Original homepage with hardcoded components
 * This is kept as a fallback/alternative to the Sanity-powered pages
 */
export default function OriginalHomePage() {
  ...
  return (
    <div className="min-h-screen font-body" style={{ backgroundColor: '#E4EDF2', color: '#3F1006' }}>
