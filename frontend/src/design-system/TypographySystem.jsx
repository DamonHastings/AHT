    ...
    <div className="max-w-7xl mx-auto p-8 bg-white">
      ...
      <div className="mb-12 pb-8 border-b-2 border-gray-200">
        ...
        <p className="font-body text-xl text-gray-600 leading-relaxed max-w-3xl">
          ...
          <strong>Nunito Sans</strong> for body text (sans-serif). This pairing creates
          a classic yet compassionate feel that's perfect for a therapy practice.
        </p>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-gray-50 p-8 rounded-lg border-2 border-gray-200">
            ...
            <div className="space-y-2 text-sm font-body text-gray-600">
              <div><strong>Use for:</strong> H1-H6, hero headlines, section titles</div>
              <div><strong>Weights:</strong> 400 (regular), 600 (semibold), 700 (bold)</div>
              <div><strong>Feel:</strong> Traditional, warm, established</div>
            </div>
          ...
          <div className="bg-gray-50 p-8 rounded-lg border-2 border-gray-200">
            ...
            <p className="font-body text-gray-700 mb-4 leading-relaxed">
              A warm sans-serif with rounded terminals for body text that feels nurturing and accessible.
            </p>
            <div className="space-y-2 text-sm font-body text-gray-600">
              <div><strong>Use for:</strong> Body text, captions, UI elements, buttons</div>
              <div><strong>Weights:</strong> 300 (light), 400 (regular), 600 (semibold)</div>
              <div><strong>Feel:</strong> Gentle, modern, approachable</div>
            </div>
            <div className="mt-6 pt-6 border-t border-gray-300">
      ...
      {/* Heading Scale */}
      <section className="mb-16">
        <h2 className="font-heading text-4xl font-semibold text-gray-900 mb-8">
          Heading Scale
        </h2>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-8">
          <div className="pb-6 border-b border-gray-200">
            <Text variant="lead">
              Lead Text - Used for introductory paragraphs and important statements that need
              extra emphasis. Slightly larger and more spacious than regular body text.
            </Text>
            <p className="font-body text-sm text-gray-500 mt-2">
          ...
          <div className="pb-6 border-b border-gray-200">
            <Text variant="large">
              Large Body Text - For sections that need better readability or when you want
              to create hierarchy within body content without using headings.
            </Text>
            <p className="font-body text-sm text-gray-500 mt-2">
          ...
          <div className="pb-6 border-b border-gray-200">
            <Text variant="body">
              Regular Body Text - The default text size for most content. This is what you'll
              use for paragraphs, lists, and general content throughout the website. It strikes
              the perfect balance between readability and space efficiency.
            </Text>
            <p className="font-body text-sm text-gray-500 mt-2">
          ...
          <div className="pb-6 border-b border-gray-200">
            <Text variant="small">
              Small Text - Used for secondary information, captions, footnotes, and metadata.
              Still readable but takes up less visual space.
            </Text>
            <p className="font-body text-sm text-gray-500 mt-2">
          ...
          <div className="pb-6 border-b border-gray-200">
            <Text variant="muted">
              Muted Text - For less important information, hints, or disabled states. Uses a
              lighter color to reduce visual prominence.
            </Text>
            <p className="font-body text-sm text-gray-500 mt-2">
      ...
      <section className="mb-16">
        ...
        <div className="bg-gray-50 p-8 rounded-lg mb-8">
          ...
          <Text variant="lead" className="mb-6">
            This is a lead paragraph that introduces the topic and draws readers in with
            slightly larger, more prominent text that commands attention without overwhelming.
          </Text>
          <Text variant="body" className="mb-4">
            Regular paragraphs follow with comfortable 16px text and generous line height
            of 1.6 for optimal reading. The Nunito Sans font's rounded characters create
            a warm, approachable feel that's perfect for therapy content.
          </Text>
          <Text variant="body" className="mb-4">
            Multiple paragraphs flow naturally together, maintaining readability and creating
            a pleasant reading experience. The combination of Crimson Text headings and
            Nunito Sans body text creates clear hierarchy.
          </Text>
