 ...
 * Showcases the Playfair Display + Roboto + Roboto Condensed pairing
 */
    ...
    <div className="max-w-7xl mx-auto p-8 bg-white">
      ...
      <div className="mb-12 pb-8 border-b-2 border-gray-200">
        ...
        <p className="font-body text-xl text-gray-600 leading-relaxed max-w-3xl">
          Our typography uses <strong>Playfair Display</strong> for headings,{" "}
          <strong>Roboto</strong> for body text, and <strong>Roboto Condensed</strong> for labels
          and UI. This pairing creates an elegant editorial feel with clear, practical support text.
        </p>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-gray-50 p-8 rounded-lg border-2 border-gray-200">
            ...
            <p className="font-body text-gray-700 mb-4 leading-relaxed">
              A high-contrast serif typeface for headings, display moments, and italic emphasis.
            </p>
            <div className="space-y-2 text-sm font-body text-gray-600">
              ...
              <div>
                <strong>Weights:</strong> 400 (regular), 500 (medium), italic
              </div>
              <div>
                <strong>Feel:</strong> Elegant, romantic, editorial
              </div>
            </div>
          ...
          <div className="bg-gray-50 p-8 rounded-lg border-2 border-gray-200">
            ...
            <p className="font-body text-gray-700 mb-4 leading-relaxed">
              A neutral sans-serif for body text that stays readable, calm, and modern.
            </p>
            <div className="space-y-2 text-sm font-body text-gray-600">
              <div>
                <strong>Use for:</strong> Body text, captions, long-form content
              </div>
              <div>
                <strong>Weights:</strong> 300 (light), 400 (regular), 500 (medium)
              </div>
              <div>
                <strong>Feel:</strong> Clean, grounded, unobtrusive
              </div>
            </div>
            <div className="mt-6 pt-6 border-t border-gray-300">
        ...
        <div className="space-y-8">
          <div className="pb-6 border-b border-gray-200">
            ...
            <p className="font-body text-sm text-gray-500 mt-2">
              48px-60px • Playfair Display Regular • Line height: 1.2
            </p>
          </div>
          <div className="pb-6 border-b border-gray-200">
            <Heading level={2}>Heading 2 - Section Titles</Heading>
            <p className="font-body text-sm text-gray-500 mt-2">
              40px-48px • Playfair Display Regular • Line height: 1.3
            </p>
          </div>
          <div className="pb-6 border-b border-gray-200">
            <Heading level={3}>Heading 3 - Subsection Titles</Heading>
            <p className="font-body text-sm text-gray-500 mt-2">
              32px-40px • Playfair Display Regular • Line height: 1.3
            </p>
          </div>
          <div className="pb-6 border-b border-gray-200">
            <Heading level={4}>Heading 4 - Card Titles</Heading>
            <p className="font-body text-sm text-gray-500 mt-2">
              24px-32px • Playfair Display Regular • Line height: 1.3
            </p>
          </div>
          <div className="pb-6 border-b border-gray-200">
            <Heading level={5}>Heading 5 - Small Headings</Heading>
            <p className="font-body text-sm text-gray-500 mt-2">
              20px-24px • Playfair Display Regular • Line height: 1.5
            </p>
          </div>
          <div className="pb-6 border-b border-gray-200">
            <Heading level={6}>Heading 6 - Labels</Heading>
            <p className="font-body text-sm text-gray-500 mt-2">
              18px-20px • Playfair Display Regular • Line height: 1.5
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-8">
          <div className="pb-6 border-b border-gray-200">
            ...
            <p className="font-body text-sm text-gray-500 mt-2">
              20px-24px • Roboto Light/Regular • Line height: 1.6
            </p>
          </div>
          <div className="pb-6 border-b border-gray-200">
            <Text variant="large">
            ...
            <p className="font-body text-sm text-gray-500 mt-2">
              18px • Roboto Regular • Line height: 1.6
            </p>
          </div>
          <div className="pb-6 border-b border-gray-200">
            <Text variant="body">
            ...
            <p className="font-body text-sm text-gray-500 mt-2">
              16px • Roboto Regular • Line height: 1.6
            </p>
          </div>
          <div className="pb-6 border-b border-gray-200">
            <Text variant="small">
            ...
            <p className="font-body text-sm text-gray-500 mt-2">
              14px • Roboto Regular • Line height: 1.6
            </p>
          </div>
          <div className="pb-6 border-b border-gray-200">
            <Text variant="muted">
            ...
            <p className="font-body text-sm text-gray-500 mt-2">
              14px • Roboto Regular • Light color • Line height: 1.6
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="bg-gray-50 p-8 rounded-lg mb-8">
          ...
          <Text variant="body" className="mb-4">
            ...
            optimal reading. Roboto stays neutral and legible so the expressive heading style can
            carry the visual personality.
          </Text>
          <Text variant="body" className="mb-4">
            Multiple paragraphs flow naturally together, maintaining readability and creating a
            pleasant reading experience. The combination of Playfair Display headings and Roboto
