...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Hero section component with background image, large heading, and consultation booking CTA. Perfect for landing pages and top-of-page content.',
      },
    },
    layout: 'fullscreen',
  },
...
export const LeftAligned = {
  args: {
    ...
    subheading: 'Professional mental health services in a warm, welcoming environment. Take the first step towards a healthier, happier you.',
...
export const LongContent = {
  args: {
    ...
    subheading: 'I provide compassionate, evidence-based therapy for individuals dealing with anxiety, depression, trauma, relationship issues, and life transitions. My approach combines cognitive-behavioral therapy, mindfulness practices, and person-centered care to help you achieve lasting positive change.',
